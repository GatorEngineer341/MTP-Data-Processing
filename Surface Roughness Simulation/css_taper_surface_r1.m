...
fr = 0.1e-3;            % feed per revolution in path direction, m/rev
...
omega0 = 1000;          % spindle speed at starting radius, rpm
r0 = 50e-3;             % starting radius, m
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
nr_fit = 0.7937e-3;          % fit value for tool nose radius from constant feed test, m
